...
<head>
    ...
    <style>
      ...
      .div-1 {
        background-image: url("{{ asset('img/juri-img.jpg') }}");
        height: 100vh;
        width: 100%;
...
<div class="div-1">
  <h1 class="text-white">Serviços Jurídicos</h1>
  <h3 class="text-light">“Prepare-se para mergulhar no mundo das leis, argumentos e equidade, e lembre-se de que cada caso é uma oportunidade de fazer a diferença na vida das pessoas.”</h3>
</div>
