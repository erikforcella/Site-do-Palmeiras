...
<div class="div-1">
  <h1 class="text-white">Contabilidade</h1>
  <h3 class="text-light">“Cada número é uma história de sucesso em construção. Aprecie a jornada de desvendar os segredos financeiros e moldar o futuro dos negócios.”</h3>
</div>
