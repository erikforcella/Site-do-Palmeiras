...
<head>
    ...
    <style>
      ...
      .apresentacao {
        background-image: url("{{ asset('img/fundo-verde.jpg') }}");
...
<div class="apresentacao">
  <h1 class="text-success">Sociedade Esportiva Palmeiras</h1>
  <h3 class="text-light">O Maior Campeão do Brasil</h3>
</div>

<div class="container bg-black">
  <div class="row">
    <div class="col-md-6">
      <h2 class="text-success">Sobre nós</h2>
      <p class="text-light">
