...
<head>
    ...
    <style>
      ...
      .apresentacao {
        background-image: url("{{ asset('img/adm3-img.jpg') }}");
        height: 100vh;
        width: 100%;
...
<div class="apresentacao">
  <h1 class="text-white">Administração</h1>
  <h3 class="text-light">“A administração é a arte de transformar desafios em oportunidades e de guiar equipes rumo ao sucesso.”</h3>
</div>
...
<div class="container bg-black">
  <div class="row">
    ...
    <div class="col-md-6">
      <img class="img-fluid ads-img" src="{{ asset('img/adm2-img.jpg') }}" alt="Imagem Administração">
    </div>
  </div>
</div>
<!--Sessão do Curso-->
