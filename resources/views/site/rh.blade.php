...
<head>
    ...
    <style>
      ...
      .div-1 {
        background-image: url("{{ asset('img/rh-img.jpg') }}");
        height: 100vh;
        width: 100%;
...
<div class="div-1">
  <h1 class="text-white">Recursos Humanos</h1>
  <h3 class="text-light">“Prepare-se para cultivar relações, inspirar equipes e ser a força que impulsiona o sucesso das pessoas e das organizações.”</h3>
</div>
...
<div class="container bg-black">
  <div class="row">
    <div class="col-md-6">
      ...
      <p class="text-light">
      O TÉCNICO EM RECURSOS HUMANOS é o profissional que detém aptidão para intermediar as relações interpessoais e éticas de uma organização. É habilitado para trabalhar na execução das rotinas administrativas de pessoal com base na Legislação Trabalhista e Previdenciária. Auxilia no controle e avaliação de subsistemas de gerenciamento e contribui para a implementação das estratégias organizacionais. Compromete-se com o desenvolvimento humano, administra pessoal, promove ações de treinamento, identifica e sugere plano de benefícios.
      </p>
    </div>
    <div class="col-md-6">
      <img class="img-fluid rh" src="{{ asset('img/rh.png') }}" alt="">
    </div>
  </div>
</div>
...
<!--Footer-->
<footer class="footer">
  <section class="bg-gradient bg-black py-5 py-xl-8 py-xxl-9 border-top border border-black">
