...
<head>
    ...
    <style>
      ...
      .apresentacao {
        background-image: url("{{ asset('img/ads2-img.jpg') }}");
        height: 100vh;
        width: 100%;
...
<div class="apresentacao">
  <h1 class="text-white">Análise e Desenvolvimento de Sistemas</h1>
  <h3 class="text-light">“Seja curioso, persistente e aberto ao aprendizado constante. Cada desafio é uma chance de crescimento e conquista.”</h3>
</div>
...
<div class="container bg-black">
  <div class="row">
    ...
    <div class="col-md-6">
      <img class="img-fluid ads-img" src="{{ asset('img/ads-img.jpg') }}" alt="Imagem Administração">
    </div>
  </div>
</div>
<!--Curso-->
